...
import francescabattistini.esame8novembre.payload.ErrorsResponseDTO;
...
public class ExceptionsHandler {
	...
	public ErrorsResponseDTO handleForbidden(AuthorizationDeniedException ex) {
		return new ErrorsResponseDTO("Non puoi accedervi senza permessi", LocalDateTime.now());
	}
	...
	public ErrorsResponseDTO handleGeneric(Exception ex) {
		ex.printStackTrace();
		return new ErrorsResponseDTO("Problemi con il server,risolviamo alla svelta", LocalDateTime.now());
	}
}
